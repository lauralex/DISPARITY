...
- The `Profiler` panel includes production readiness tables for the forty v25 points, thirty-six v28 diversified points, thirty v29 public-demo points, thirty-six v30 vertical-slice points, thirty v31 diversified roadmap points, sixty v32 roadmap points, fifty v33 playable-demo points, and sixty v34 AAA-foundation points, making editor workflow, asset promotion, rendering, runtime sequencer, audio production, publishing, and playable-demo coverage inspectable while the build is running.
