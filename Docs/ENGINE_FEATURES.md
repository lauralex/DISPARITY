...
- The `Profiler` panel includes production readiness tables for the forty v25 points, thirty-six v28 diversified points, thirty v29 public-demo points, thirty-six v30 vertical-slice points, thirty v31 diversified roadmap points, sixty v32 roadmap points, fifty v33 playable-demo points, sixty v34 AAA-foundation points, fifty v35 engine-architecture points, and sixty v36 mixed engine/game/editor points, making editor workflow, asset promotion, rendering, runtime sequencer, audio production, publishing, playable-demo coverage, core engine services, typed config, telemetry, editor-panel registry state, and the game source split inspectable while the build is running.
