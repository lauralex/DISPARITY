...
- The v36 source split moves stable game batch data into `DisparityGame/Source/DisparityGame/GameFollowupCatalog.*` and module/source-readability metadata into `DisparityGame/Source/DisparityGame/GameModuleRegistry.*`.
