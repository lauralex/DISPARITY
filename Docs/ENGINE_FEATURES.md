...
- The `Profiler` panel includes production readiness tables for the forty v25 points, thirty-six v28 diversified points, thirty v29 public-demo points, thirty-six v30 vertical-slice points, thirty v31 diversified roadmap points, sixty v32 roadmap points, fifty v33 playable-demo points, sixty v34 AAA-foundation points, fifty v35 engine-architecture points, sixty v36 mixed engine/game/editor points, and thirty v38 diversified engine/editor/game points, while v39 roadmap readiness is enforced through runtime reports, schemas, baselines, and tooling. Together these make editor workflow, asset promotion, rendering, runtime sequencer, audio production, publishing, playable-demo coverage, core engine services, typed config, telemetry, editor-panel workspace state, runtime command state, event-route coverage, and the game source split inspectable while the build is running.
...
- `RuntimeCommandRegistry` centralizes named runtime/editor/game commands with categories, default bindings, enable/disable state, duplicate tracking, execution diagnostics, search, execution history, binding-conflict detection, category summaries, and required-category validation for the next command-palette pass.
- `EditorPanelRegistry` centralizes panel descriptors, deterministic ordering, docking targets, visibility toggles, searchable panels, workspace presets, saved dock-layout descriptors, team-default flags, workspace command bindings, controller navigation hints, toolbar customization slots, workspace application diagnostics, and simple navigation state for the live editor panel surface.
