...
$requiredKeys = @(
    ...
    "min_v46_catalog_selectable_rows",
    "min_v46_catalog_preview_selections",
    "min_v46_catalog_preview_cycles",
    "min_v46_catalog_preview_clears",
    "min_v46_catalog_preview_details",
    "min_v46_catalog_focused_beacons",
    "min_v46_engine_preview_bindings",
    "min_v46_editor_preview_bindings",
    "min_v46_game_preview_bindings",
    "min_v46_runtime_action_commands",
    "min_v46_verification_assets",
    "min_v46_catalog_action_preview_points",
    "min_v47_catalog_execute_requests",
    "min_v47_catalog_execution_stops",
    "min_v47_catalog_execution_pulses",
    "min_v47_engine_executable_bindings",
    "min_v47_editor_executable_bindings",
    "min_v47_game_executable_bindings",
    "min_v47_game_execution_overlays",
    "min_v47_world_execution_markers",
    "min_v47_action_route_beams",
    "min_v47_execution_detail_rows",
    "min_v47_verification_assets",
    "min_v47_catalog_execution_points",
    "min_v48_runtime_action_plans",
    "min_v48_runtime_ready_action_plans",
    "min_v48_high_impact_action_plans",
    "min_v48_editor_visible_action_plans",
    "min_v48_playable_action_plans",
    "min_v48_action_director_requests",
    "min_v48_action_director_queue_depth",
    "min_v48_action_director_history_rows",
    "min_v48_director_cinematic_bursts",
    "min_v48_director_route_ribbons",
    "min_v48_director_encounter_ghosts",
    "min_v48_director_editor_queue_rows",
    "min_v48_director_plan_summary_rows",
    "min_v48_verification_assets",
    "min_v48_action_director_points",
