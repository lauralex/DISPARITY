...
$requiredKeys = @(
    ...
    "min_v49_runtime_mutation_plans",
    "min_v49_runtime_mutation_runtime_plans",
    "min_v49_editor_mutation_plans",
    "min_v49_gameplay_mutation_plans",
    "min_v49_budget_bound_mutation_plans",
    "min_v49_action_mutation_requests",
    "min_v49_mutation_queue_depth",
    "min_v49_engine_budget_mutations",
    "min_v49_scheduler_budget_mutations",
    "min_v49_streaming_budget_mutations",
    "min_v49_render_budget_mutations",
    "min_v49_editor_workspace_mutations",
    "min_v49_editor_command_mutations",
    "min_v49_trace_event_rows",
    "min_v49_game_spawned_encounter_waves",
    "min_v49_game_objective_route_mutations",
    "min_v49_game_combat_sandbox_mutations",
    "min_v49_mutation_world_bursts",
    "min_v49_mutation_world_pillars",
    "min_v49_mutation_wave_ghosts",
    "min_v49_mutation_panel_rows",
    "min_v49_action_mutation_points",
    "min_v50_physics_bodies",
    "min_v50_physics_dynamic_bodies",
    "min_v50_physics_static_bodies",
    "min_v50_physics_trigger_bodies",
    "min_v50_physics_steps",
    "min_v50_physics_substeps",
    "min_v50_physics_contacts",
    "min_v50_physics_raycasts",
    "min_v50_physics_sweeps",
    "min_v50_physics_overlaps",
    "min_v50_physics_character_moves",
    "min_v50_physics_character_grounded_moves",
    "min_v50_physics_debug_lines",
    "min_v50_physics_visible_bodies",
    "min_v50_physics_panel_rows",
    "min_v50_physics_foundation_points",
    "min_v51_physics_contact_events",
    "min_v51_physics_trigger_events",
    "min_v51_physics_layer_summaries",
    "min_v51_physics_snapshot_captures",
    "min_v51_physics_snapshot_restores",
    "min_v51_physics_destructible_chunks",
    "min_v51_physics_visible_chunks",
    "min_v51_physics_event_rows",
    "min_v51_physics_layer_rows",
    "min_v51_physics_event_markers",
    "min_v51_physics_snapshot_bodies",
    "min_v51_physics_integration_points",
