...
Invoke-Step "Production followup manifest review" {
    ...
    & (Join-Path $PSScriptRoot "ReviewProductionBatch.ps1") `
        ...
        -KeyPrefix "v47"
    & (Join-Path $PSScriptRoot "ReviewProductionBatch.ps1") `
        -ManifestPath "Assets/Verification/V48ActionDirector.dfollowups" `
        -ExpectedCount 24 `
        -OutputPath "Saved/Verification/v48_action_director_review.json" `
        -KeyPrefix "v48"
    & (Join-Path $PSScriptRoot "ReviewProductionBatch.ps1") `
        -ManifestPath "Assets/Verification/V49ActionMutation.dfollowups" `
        -ExpectedCount 24 `
        -OutputPath "Saved/Verification/v49_action_mutation_review.json" `
        -KeyPrefix "v49"
    & (Join-Path $PSScriptRoot "ReviewProductionBatch.ps1") `
        -ManifestPath "Assets/Verification/V50PhysicsFoundation.dfollowups" `
        -ExpectedCount 24 `
